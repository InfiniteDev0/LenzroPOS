// Pure allocation math, shared in spirit with apps/pos's copy of this
// file (no shared package between the two apps for business logic yet —
// see IMPROVISING_LOG.md). A payment's logged amount is always exactly
// what ends up allocated, never more — that's what keeps
// Owed = Taken - Paid correct without drifting.
